...
Use A4 portrait, EZIWORK navy `#082f58`, electric blue `#0a67ff`, orange `#f37021`, pale-blue surfaces, large question titles, one dominant visual per evidence page, and deliberate whitespace.
