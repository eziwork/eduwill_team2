...
def main() -> int:
    ...
    try:
        ...
        print(f"ERROR: audit runtime failure: {exc}")
        return 3
    ...
    print(f"EVIDENCE_FINGERPRINT: {result['evidence_fingerprint']}")
    print(f"VISIBLE_PAYLOAD_FINGERPRINT: {result['visible_payload_fingerprint']}")
    print(f"ASSET_MANIFEST_FINGERPRINT: {result['asset_manifest_fingerprint']}")
    print(f"COMBINED_RELEASE_FINGERPRINT: {result['combined_release_fingerprint']}")
