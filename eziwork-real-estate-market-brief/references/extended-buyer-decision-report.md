...
- A nine-page report is complete only when all nine distinct page purposes are present. If evidence for a page is missing, show the limitation or fall back to the compact profile; do not pad with generic prose.
